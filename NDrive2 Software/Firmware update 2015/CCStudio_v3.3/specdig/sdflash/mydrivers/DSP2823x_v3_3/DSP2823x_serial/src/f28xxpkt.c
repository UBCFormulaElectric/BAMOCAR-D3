...
*
* HISTORY:
*  November 29, 2007: Ported to F2833x (C. Peng)
*  March 5, 2007: Ported to F2804x (D. Alter)
*  June 27, 2005: Ported to F280x from original F281x based f28xxpkt.c (D. ALTER)
*
* DESCRIPTION:
*
* GLOBALS
