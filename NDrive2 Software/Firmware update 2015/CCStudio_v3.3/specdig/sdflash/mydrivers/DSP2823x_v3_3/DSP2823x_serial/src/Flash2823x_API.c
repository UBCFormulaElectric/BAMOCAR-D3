/*H*****************************************************************************
*
* $Archive:: /TI/product/F28xxSerialFlash/src/Flash2823x_API.c                 $
* $Revision:: 3                                                                $
...
* HISTORY:
*
*  August 29, 2008 : Ported to F2823x from F2833x_API.c (C. Peng)
...
#if FLASH_F28235
	#define SECTOR_F28XX SECTOR_F28235
#elif FLASH_F28234
    #define SECTOR_F28XX SECTOR_F28234
#elif FLASH_F28232
    #define SECTOR_F28XX SECTOR_F28232
#endif
...
// For F2823x devices, the password match flow is performed by the DSP code
// in the project F2823xPasswordMF.out.  This gets loaded by the serial
// SDFlash before the F2823xSerialFlash.out file.  F2823x users should
// modify and rebuild the F2823xPasswordMF project to include their
// proper passwords.
/*
