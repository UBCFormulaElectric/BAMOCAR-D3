/*H***************************************************************************
*
* $Archive:: /TI/product/F28xxSerialFlash/src_host/f2833xprg.c               $
* $Revision:: 3                                                              $
...
* HISTORY:
*
*  Nov. 29, 2007: Changed PasswordMF pathname to: F2833xPasswordMF.out for
*                 F2833x devices (C. Peng)
...
PrgOpen( DWORD Handle )
{
    ...
    char    PrgPasswordMFFileName[] = "F2833xPasswordMF.out";
