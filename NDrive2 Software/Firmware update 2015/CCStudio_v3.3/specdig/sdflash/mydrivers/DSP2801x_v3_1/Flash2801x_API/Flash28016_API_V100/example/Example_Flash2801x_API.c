//###########################################################################
//
// FILE:  Example_Flash2801x_API.c	
//
// TITLE: F2801x Flash API Example
//
...
//
//###########################################################################
// $TI Release: F28015 API Release V1.0 $
...
/*------------------------------------------------------------------
 ...
 must be followed:
      ...
      1. Modify Flash2801x_API_Config.h for your targets operating
         conditions.
      2. Include Flash2801x_API_Library.h in the application.
...
------------------------------------------------------------------*/
   ...
   Uint16 Status;
/*------------------------------------------------------------------
 Initalize the PLLCR value before calling any of the F2801x Flash API 
 functions.
        
     Check to see if the PLL needs to changed
     PLLCR_VALUE is defined in Example_Flash2801x_API.h
...
/*------------------------------------------------------------------
  Initalize Flash_CPUScaleFactor.
   ...
   SCALE_FACTOR is defined in Example_Flash2801x_API.h as   
...
------------------------------------------------------------------*/
   ...
   // SECTORB, SECTORC are defined in Flash2801x_API_Library.h
...
------------------------------------------------------------------*/
   ...
   // SECTORB is defined in Flash2801x_API_Library.h
   ...
   // SECTORC is defined in Flash2801x_API_Library.h
...
Uint16 Example_CsmUnlock()
{
    ...
    // These are defined in Example_Flash2801x_CsmKeys.asm
