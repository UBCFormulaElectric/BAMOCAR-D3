...
// Checkin $Date: August 15, 2006   13:33:31 $
//###########################################################################
//
// FILE:  Flash2801x_API_Config.h
//
// TITLE: F2804x Flash Algo's - User Settings
//
// NOTE:  This file contains user defined settings that
//        are used by the F2801x Flash APIs.
//
//###########################################################################
// $TI Release:$
// $Release Date:$
...
#ifndef FLASH2801X_API_CONFIG_H
#define FLASH2801X_API_CONFIG_H
...
#define FLASH_F28015   0
#define FLASH_F28016   1
...
/*-----------------------------------------------------------------------------
   2. Specify the clock rate of the CPU (SYSCLKOUT) in nS.
      ...
      Example:  CLKIN is a 20MHz crystal. 
                ...
                If the application will set PLLCR = 0x6 then the CPU clock 
                will be 60Mhz (SYSCLKOUT = 60MHz).  
...
#endif // -- end FLASH2801X_API_CONFIG_H 
