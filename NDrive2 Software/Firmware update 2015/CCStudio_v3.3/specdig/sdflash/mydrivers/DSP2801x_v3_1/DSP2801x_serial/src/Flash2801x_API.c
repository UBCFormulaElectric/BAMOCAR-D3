...
*
* HISTORY:
*  March 5, 2007: Ported to F2801x from Flash2808_API.c. (D. Alter)
...
*                 (D. ALTER)
*
* DESCRIPTION: Interface to TI F2801x API.  Ported from the TI example code
*              so support SDFlash.
*
* GLOBALS 
*
...
#if FLASH_F28015
	#define SECTOR_F28XX SECTOR_F28015
#elif FLASH_F28016
	#define SECTOR_F28XX SECTOR_F28016
#endif
