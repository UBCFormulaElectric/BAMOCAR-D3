...
// Checkin $Date: August 3, 2006   16:32:57 $
//###########################################################################
//
// FILE:   DSP2804x_EPwm.c
//
// TITLE:  DSP2804x ePWM Initialization & Support Functions.
//
//###########################################################################
...
void InitEPwmGpioConfig0(void)
{
   InitEPwmGpio();
}


void InitEPwmGpioConfig3(void)
{
   EALLOW;
   GpioCtrlRegs.GPAMCFG.bit.EPWMMODE = 3;
   EDIS;
   InitEPwmGpioMux();
}

void InitEPwmGpioMux(void)
{

/* Enable internal pull-up for the selected pins */
// Pull-ups can be enabled or disabled by the user. 
// This will enable the pullups for the specified pins.
// Comment out unwanted lines.
   EALLOW;
...
/* Configure ePWM pins using GPIO regs*/
...
// These functions are for the default 280x compatible mode
void InitEPwm1Gpio(void)
{
   EALLOW;

   GpioCtrlRegs.GPAMCFG.bit.EPWMMODE = 0;
