/*H*****************************************************************************
*
* $Archive:: /TI/product/F28xxSerialFlash/src/Flash2804x_API.c                 $
* $Revision:: 3                                                                $
...
* HISTORY:
*
*  March 5, 2007: Ported to F2804x from Flash2808_API.c. (D. Alter)
...
*                 (D. ALTER)
*
* DESCRIPTION: Interface to TI F2804x API.  Ported from the TI example code
*              so support SDFlash.
*
* GLOBALS 
*
...
#if FLASH_F28044
	#define SECTOR_F28XX SECTOR_F28044
#endif
...
// For F2804x devices, the password match flow is performed by the DSP code
// in the project F28xxPasswordMF.out.  This gets loaded by the serial
// SDFlash before the F2804xSerialFlash.out file.  F2804x users should
