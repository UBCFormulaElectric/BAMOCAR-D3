/*H*****************************************************************************
*
* $Archive:: /TI/product/F28xxSerialFlash/src/Flash2833x_API.c                 $
* $Revision:: 3                                                                $
...
* HISTORY:
*
*  August 29, 2008: Added F28334 and F28332 sector options (C.Peng)
*  November 29, 2007: Ported to F2833x from Flash2804x_API.c (C. Peng)
*  March 5, 2007: Ported to F2833x from Flash2808_API.c. (D. Alter)
...
*                 (D. ALTER)
*
* DESCRIPTION: Interface to TI F2833x API.  Ported from the TI example code
*              so support SDFlash.
*
* GLOBALS
*
...
#if FLASH_F28335
	#define SECTOR_F28XX SECTOR_F28335
#elif FLASH_F28334
    #define SECTOR_F28XX SECTOR_F28334
#elif FLASH_F28332
    #define SECTOR_F28XX SECTOR_F28332
#endif
...
// For F2833x devices, the password match flow is performed by the DSP code
// in the project F2833xPasswordMF.out.  This gets loaded by the serial
// SDFlash before the F2833xSerialFlash.out file.  F2833x users should
// modify and rebuild the F2833xPasswordMF project to include their
// proper passwords.
/*
