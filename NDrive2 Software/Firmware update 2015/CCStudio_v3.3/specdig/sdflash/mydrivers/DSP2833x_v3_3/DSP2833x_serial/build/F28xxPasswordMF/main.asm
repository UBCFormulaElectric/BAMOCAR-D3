...
*   code.
*
* Devices: TMS320F28335, TMS30F28334, TMS320F28332,
*               TMS320F28235, TMS320F28234, TMS320F28232
*
* Author: Original - David M. Alter, Texas Instruments Inc.
*            
*
* History:
*   11/27/07 - Modified for TMS320F28335 password locations
*
*   03/16/07 - Modified to overwrite security passwords in RAM after
*              CSM is unlocked. (D. Alter)
*   06/27/05 - original for F280x devices (D. Alter)
*
...
PWL0         .set     0x33FFF8   ; Password 0 
PWL1         .set     0x33FFF9   ; Password 1 
PWL2         .set     0x33FFFA   ; Password 2 
PWL3         .set     0x33FFFB   ; Password 3 
PWL4         .set     0x33FFFC   ; Password 4 
PWL5         .set     0x33FFFD   ; Password 5 
PWL6         .set     0x33FFFE   ; Password 6 
PWL7         .set     0x33FFFF   ; Password 7 
