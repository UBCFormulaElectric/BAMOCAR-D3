//###########################################################################
//
// FILE:  Example_Flash2801x_API.h	
//
// TITLE: F2801x Flash API example include file
//
// DESCRIPTION:
//
// Function prototypes and macros for the F2801x Flash API library examples.
//
//###########################################################################
...
#ifndef EXAMPLE_FLASH2801x_API_H
#define EXAMPLE_FLASH2801x_API_H
...
/*---- DSP2801x Header Files -- from TI's website. ----------*/
...
/*-----------------------------------------------------------------------------
     Specify the PLLCR (PLL Control Register) value.   
      ...
      Example:  CLKIN is a 20MHz crystal.  
                ...
                In this case, PLLCR must be set to 6 (0x0006)
                Uncomment the line: #define PLLCR_VALUE 6
...
/*---------------------------------------------------------------------------
   ...
   They are defined in Example_Flash2801x_CsmKeys.asm
--------------------------------------------------------------------------*/
...
#endif // ---- End of EXAMPLE_FLASH2801x_API_H     
