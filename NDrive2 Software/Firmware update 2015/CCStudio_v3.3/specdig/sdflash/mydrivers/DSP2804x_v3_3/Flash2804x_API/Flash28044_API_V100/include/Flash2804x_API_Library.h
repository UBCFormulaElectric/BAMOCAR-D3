...
// Checkin $Date: August 15, 2006   13:32:41 $
//###########################################################################
//
// FILE:  Flash2804x_API_Library.h	
//
// TITLE: F2804x Flash Algo's main include file
//
// DESCRIPTION:
//
//       This file should be included in any project that uses any of the
//       the F2804x flash APIs.    
//
//###########################################################################
...
#ifndef FLASH2804X_API_LIBRARY_H
#define FLASH2804X_API_LIBRARY_H

#include "Flash2804x_API_Config.h"
...
#if FLASH_F28044
// All sectors on an F28044 - Sectors A - D
#define SECTOR_F28044 (SECTORA|SECTORB|SECTORC|\
                       SECTORD)
#endif // -- end FLASH_F28044
...
#if FLASH_F28044
#define Flash_Erase(a,b)          Flash28044_Erase(a,b)
#define Flash_Program(a,b,c,d)    Flash28044_Program(a,b,c,d)
#define Flash_Verify(a,b,c,d)     Flash28044_Verify(a,b,c,d)
#define Flash_ToggleTest(a,b)     Flash28044_ToggleTest(a,b)
#define Flash_DepRecover()        Flash28044_DepRecover()
#define Flash_APIVersionHex()     Flash28044_APIVersionHex()
#define Flash_APIVersion()        Flash28044_APIVersion()
#endif
...
/*---------------------------------------------------------------------------
   ...
   Flash28_API:
   {
        Flash28045_API_Library.lib(.econst) 
        Flash28045_API_Library.lib(.text)
   } LOAD = FLASH, 
     RUN = SARAM, 
...
#endif // -- end FLASH2804x_API_LIBRARY_H 
