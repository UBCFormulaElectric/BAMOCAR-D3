//###########################################################################
//
// FILE:  Example_Flash2804x_API.c	
//
// TITLE: F2804x Flash API Example
//
...
/*------------------------------------------------------------------
 ...
 must be followed:
      ...
      1. Modify Flash2804x_API.config.h for your targets operating
         conditions.
      2. Include Flash2804x_API_Library.h in the application.
...
------------------------------------------------------------------*/
   ...
   Uint16 Status;
/*------------------------------------------------------------------
 Initalize the PLLCR value before calling any of the F2804x Flash API 
 functions.
        
     Check to see if the PLL needs to changed
     PLLCR_VALUE is defined in Example_Flash2804x_API.h
...
/*------------------------------------------------------------------
  Initalize Flash_CPUScaleFactor.
   ...
   SCALE_FACTOR is defined in Example_Flash2804x_API.h as   
...
------------------------------------------------------------------*/
   ...
   // SECTORB, SECTORC are defined in Flash2804x_API_Library.h
...
------------------------------------------------------------------*/
   ...
   // SECTORB is defined in Flash2804x_API_Library.h
   ...
   // SECTORC is defined in Flash2804x_API_Library.h
...
Uint16 Example_CsmUnlock()
{
    ...
    // These are defined in Example_Flash2804x_CsmKeys.asm
