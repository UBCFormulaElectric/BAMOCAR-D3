/*H***************************************************************************
*
* $Archive:: /TI/product/F28xxSerialFlash/src/drv2804xsci.h                  $
* $Revision:: 2                                                              $
* $Date:: 10/29/03 11:34a                                                    $
* $Author:: Tonyc                                                            $
*
* HISTORY:
*  March 5, 2007: Ported from drv2808sci.h (D. Alter)
*
* DESCRIPTION:
*
* USAGE/LIMITATIONS:
...
#ifndef drv2804xsci_h
#define drv2804xsci_h
...
// DSP2804x header file v1.00 does not support SCI-B.  Until there is a F2804x
// device that has SCI-B, we must compile around the code that uses SCI-B
// references in the header files.
#define ALLOW_SCI_B         0      /* 0 = no SCI-B.  1 = allow SCI-B use.   */
